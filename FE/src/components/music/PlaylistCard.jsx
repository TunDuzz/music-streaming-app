...
const PlaylistCard = ({ playlist }) => {
    ...
    return (
        ...
        >
            <div className="relative aspect-square w-full mb-4 rounded-md overflow-hidden shadow-lg bg-[#333] flex items-center justify-center">
            ...
            <div className="flex flex-col gap-1">
                ...
                <p className="text-sm text-gray-400 truncate">
                    Example: By {playlist.username || 'User'}
                </p>
            </div>
        </div>
    );
